...
@register_layer("GritTransformer_Modif")
class GritTransformerLayer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, num_heads,
        ...
        self.O_e = nn.Linear(out_channels, out_channels)
        ...
        self.norm_node_1 = nn.BatchNorm1d(out_channels, eps=1e-5, momentum=cfg.bn_momentum)
        self.norm_node_2 = nn.BatchNorm1d(out_channels, eps=1e-5, momentum=cfg.bn_momentum)
        self.norm_edge = nn.BatchNorm1d(out_channels, eps=1e-5, momentum=cfg.bn_momentum)

        self.ffn_layer1 = nn.Linear(out_channels, out_channels * 2)
        self.ffn_layer2 = nn.Linear(out_channels * 2, out_channels)
    ...
    def forward(self, batch):
        ...
        x = x_attn.view(batch.num_nodes, -1)
        ...
        e = self.O_e(e)
        e = e_in + e_attn # Residual connection
